  ...
  insert(t, e) {
    return new dt(
      ...
      this.root
        ...
        .copy(null, null, wt.BLACK, null, null)
    );
  }
...
class wt {
  constructor(t, e, n, s, i) {
    (this.key = t),
      (this.value = e),
      (this.color = null != n ? n : wt.RED),
      (this.left = null != s ? s : wt.EMPTY),
      (this.right = null != i ? i : wt.EMPTY),
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function St(
  t
) {
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function qt(
  t,
  e
) {
  if (t === e) return !0;
  ...
  switch (n) {
    ...
    case 3 /* TimestampValue */:
      return (function (t, e) {
        ...
        const n = Vt(t.timestampValue),
          s = Vt(e.timestampValue);
    ...
    case 8 /* GeoPointValue */:
      return (function (t, e) {
        return (
          vt(t.geoPointValue.latitude) === vt(e.geoPointValue.latitude) &&
          vt(t.geoPointValue.longitude) === vt(e.geoPointValue.longitude)
        );
      })(t, e);
    ...
    case 2 /* NumberValue */:
      return (function (t, e) {
        if ("integerValue" in t && "integerValue" in e)
          return vt(t.integerValue) === vt(e.integerValue);
    ...
    case 10 /* ObjectValue */:
      return (function (t, e) {
        ...
        for (const t in n)
          if (n.hasOwnProperty(t) && (void 0 === s[t] || !qt(n[t], s[t])))
            return !1;
        return !0;
      })(
...
function Gt(t, e) {
  ...
  switch (n) {
    ...
    case 2 /* NumberValue */:
      return (function (t, e) {
        const n = vt(t.integerValue || t.doubleValue),
          s = vt(e.integerValue || e.doubleValue);
        return n < s
          ? -1
          : n > s
          ? 1
...
function Wt(t) {
  return "nullValue" in t
    ...
    ? t.stringValue
    : "bytesValue" in t
    ? St(t.bytesValue).toBase64()
    : "referenceValue" in t
    ? ((n = t.referenceValue), $t.fromName(n).toString())
    : "geoPointValue" in t
...
/** Creates a deep copy of `source`. */ function te(t) {
  ...
  if (t.arrayValue) {
    ...
    for (let n = 0; n < (t.arrayValue.values || []).length; ++n)
      e.arrayValue.values[n] = te(t.arrayValue.values[n]);
    return e;
  }
  return Object.assign({}, t);
}

/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */ function ee(
  t
) {
  return (
...
/** Returns the lowest value for the given value type (inclusive). */ function ne(
  t
) {
  return "nullValue" in t
    ? Lt
...
/** Returns the largest value for the given value type (exclusive). */ function se(
  t
) {
  return "nullValue" in t
    ? {
...
/** Returns all directional (ascending/descending) segments for this index. */ function le(
  t
) {
  ...
  if (null === e.P) {
    ...
    null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup),
      ...
      (t += e.filters
        .map((t) => {
          return (
            (e = t).field.canonicalString() + e.op.toString() + jt(e.value)
          );
          var e;
        })
        .join(",")),
      ...
      (t += e.orderBy
        ...
        .join(",")),
      Ot(e.limit) || ((t += "|l:"), (t += e.limit)),
      e.startAt &&
        ((t += "|lb:"),
        (t += e.startAt.inclusive ? "b:" : "a:"),
        (t += e.startAt.position.map((t) => jt(t)).join(","))),
      e.endAt &&
        ((t += "|ub:"),
        (t += e.endAt.inclusive ? "a:" : "b:"),
        (t += e.endAt.position.map((t) => jt(t)).join(","))),
      (e.P = t);
  }
  return e.P;
}
...
function Te(t) {
  ...
  return (
    ...
    t.startAt &&
      ...
      (e += t.startAt.position.map((t) => jt(t)).join(","))),
    t.endAt &&
      ((e += ", endAt: "),
      (e += t.endAt.inclusive ? "a:" : "b:"),
      (e += t.endAt.position.map((t) => jt(t)).join(","))),
    `Target(${e})`
  );
}
...
function Ee(t, e) {
  ...
  for (let i = 0; i < t.filters.length; i++)
    if (
      ((n = t.filters[i]),
      (s = e.filters[i]),
      n.op !== s.op || !n.field.isEqual(s.field) || !qt(n.value, s.value))
    )
      return !1;
  var n, s;
  return (
...
/** Returns the number of segments of a perfect index for this target. */ class Ve extends class {} {
  ...
  matches(t) {
    ...
    return "!=" /* NOT_EQUAL */ === this.op
      ? null !== e && this.v(Gt(e, this.value))
      : null !== e && Ut(this.value) === Ut(e) && this.v(Gt(e, this.value));
...
function Ce(t, e) {
  ...
  ).map((t) => $t.fromName(t.referenceValue));
}
...
/** A Filter that implements the array-contains-any operator. */ class Oe extends Ve {
  ...
  matches(t) {
    const e = t.data.field(this.field);
    return (
      !(!Jt(e) || !e.arrayValue.values) &&
      e.arrayValue.values.some((t) => Kt(this.value.arrayValue, t))
    );
  }
}
...
function Be(t, e, n) {
  ...
  for (let i = 0; i < t.position.length; i++) {
    ...
    if (r.field.isKeyField())
      s = $t.comparator($t.fromName(o.referenceValue), n.key);
    else {
  ...
  if (null === e.D) {
    ...
    if (null !== t && null === n)
      ...
      t.isKeyField() || e.D.push(new Fe(t)),
        e.D.push(new Fe(Et.keyField(), "asc" /* ASCENDING */));
    else {
      let t = !1;
  ...
  if (!e.C)
    if ("F" /* First */ === e.limitType)
      ...
      const n = e.endAt ? new Me(e.endAt.position, e.endAt.inclusive) : null,
        s = e.startAt ? new Me(e.startAt.position, e.startAt.inclusive) : null;
 ...
 */ function bn(t, e) {
  ...
  if (null === e)
    return t.isNoDocument()
      ? new Mn(t.key, An.none())
      : new Cn(t.key, t.data, An.none());
  {
    const n = t.data,
      s = oe.empty();
 ...
 */ function vn(t, e, n, s) {
  return t instanceof Cn
    ...
    ? (function (t, e, n, s) {
        ...
        const i = On(t.fieldTransforms, s, e),
          r = e.data;
        if (
          (r.setAll(Nn(t)),
          r.setAll(i),
    ...
    : (function (t, e, n) {
        if (Rn(t.precondition, e))
          return e.convertToNoDocument(e.version).setHasLocalMutations(), null;
        return n;
      })(
        /**
 ...
 */ class ns {
  ...
  static createSynthesizedRemoteEventForCurrentChange(t, e) {
    const n = new Map();
    return (
      n.set(t, ss.createSynthesizedTargetChangeForCurrentChange(t, e)),
      new ns(ct.min(), n, es(), Qn(), Zn())
    );
  }
}
    ...
    this.st.forEach((n, s) => {
      ...
      if (i) {
        if (n.current && Ae(i.target)) {
          ...
          null !== this.it.get(e) ||
            this.It(s, e) ||
            this.ct(s, e, ae.newNoDocument(e, t));
        }
        n.j && (e.set(s, n.H()), n.J());
      }
    });
...
/** Creates a Document proto from key and fields (but no create/update time) */ function bs(
  t,
  e,
  n
) {
...
function vs(t, e) {
  return "found" in e
    ? (function (t, e) {
        ...
        const n = Ts(t, e.found.name),
          s = gs(e.found.updateTime),
          i = new oe({
            mapValue: {
...
function Ss(t, e) {
  ...
  if ("targetChange" in e) {
    ...
    const i = Ts(t, s.document.name),
      r = gs(s.document.updateTime),
      o = new oe({
        mapValue: {
          fields: s.document.fields,
        },
      }),
      u = ae.newFoundDocument(i, r, o),
      a = s.targetIds || [],
    ...
    s.document;
    const i = Ts(t, s.document),
      r = s.readTime ? gs(s.readTime) : ct.min(),
      o = ae.newNoDocument(i, r),
...
function js(t) {
  let e = "";
  for (let n = 0; n < t.length; n++)
    e.length > 0 && (e = zs(e)), (e = Ws(t.get(n), e));
  return zs(e);
}

/** Encodes a single segment of a resource path into the given result */ function Ws(
  t,
  e
) {
  let n = e;
 ...
 */ function Hs(t) {
  ...
  const e = t.length;
  if ((U(e >= 2), 2 === e))
    return U("" === t.charAt(0) && "" === t.charAt(1)), It.emptyPath();
 ...
 * information.
 */ const Zs = {},
  ti = ["prefixPath", "collectionGroup", "readTime", "documentId"],
  ei = ["prefixPath", "collectionGroup", "documentId"],
  ni = ["collectionGroup", "readTime", "prefixPath", "documentId"],
  si = ["canonicalId", "targetId"],
  ii = ["targetId", "path"],
  ri = ["path", "targetId"],
  oi = ["collectionId", "parent"],
  ui = ["indexId", "uid"],
  ai = ["uid", "sequenceNumber"],
  ci = [
    "indexId",
    "uid",
    "arrayValue",
  ...
  hi = ["indexId", "uid", "orderedDocumentKey"],
  li = ["userId", "collectionPath", "documentId"],
  fi = ["userId", "collectionPath", "largestBatchId"],
  di = ["userId", "collectionGroup", "largestBatchId"],
  _i = [
    ...[
      ...[
        ...[
  ...
  gi = mi,
  yi = [...gi, "indexConfiguration", "indexState", "indexEntries"];
 ...
 */ class Ai {
  ...
  /** Deletes the specified database. */ static delete(t) {
    return (
      M("SimpleDb", "Removing database:", t),
      vi(window.indexedDB.deleteDatabase(t)).toPromise()
    );
  }
   ...
   */ async Nt(t) {
    return (
      ...
      this.Ot && (this.db.onversionchange = (t) => this.Ot(t)),
      this.db
    );
  }
  Mt(t) {
  ...
  async runTransaction(t, e, n, s) {
    ...
    for (;;) {
      ...
      try {
        ...
        const e = Ei.open(this.db, t, i ? "readonly" : "readwrite", n),
          r = s(e)
            .next((t) => (e.Pt(), t))
            .catch(
              (t) => (
                // Abort the transaction if there was an error.
                e.abort(t), Ti.reject(t)
              )
            )
            .toPromise();
 ...
 */ class Vi {
  ...
  put(t, e) {
    ...
    return (
      void 0 !== e
        ? (M("SimpleDb", "PUT", this.store.name, t, e),
          (n = this.store.put(e, t)))
        : (M("SimpleDb", "PUT", this.store.name, "<auto-key>", t),
          (n = this.store.put(t))),
      vi(n)
    );
  }
   ...
   */ get(t) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return vi(this.store.get(t)).next(
      (e) => (
        // Normalize nonexistence to null.
        void 0 === e && (e = null),
        M("SimpleDb", "GET", this.store.name, t, e),
        e
      )
    );
  }
 ...
 */ class Ni {
   ...
   */ applyToLocalView(t, e) {
    ...
    for (const n of this.baseMutations)
      n.key.isEqual(t.key) && (e = vn(n, t, e, this.localWriteTime));
   ...
   */ applyToLocalDocumentSet(t, e) {
    ...
    return (
      this.mutations.forEach((s) => {
        ...
        const u = bn(r, o);
        null !== u && n.set(s.key, u),
          r.isValidDocument() || r.convertToNoDocument(ct.min());
      }),
      n
    );
  }
  ...
  isEqual(t) {
    return (
      ...
      ot(this.mutations, t.mutations, (t, e) => Dn(t, e)) &&
      ot(this.baseMutations, t.baseMutations, (t, e) => Dn(t, e))
    );
  }
}
...
/** Decodes a remote document from storage locally to a Document. */ function $i(
  t,
  e
) {
  let n;
  if (e.document) n = Vs(t.Jt, e.document, !!e.hasCommittedMutations);
  else if (e.noDocument) {
    const t = $t.fromSegments(e.noDocument.path),
      s = qi(e.noDocument.readTime);
    (n = ae.newNoDocument(t, s)),
      e.hasCommittedMutations && n.setHasCommittedMutations();
  } else {
    if (!e.unknownDocument) return L();
    {
      const t = $t.fromSegments(e.unknownDocument.path),
...
function Ki(t, e) {
  ...
  const s = e.mutations.map((e) => Cs(t.Jt, e)),
  ...
  const e = qi(t.readTime),
    n =
      void 0 !== t.lastLimboFreeSnapshotVersion
        ? qi(t.lastLimboFreeSnapshotVersion)
        : ct.min();
  let s;
  var i;
  return (
 ...
 */ class Xi {
  ...
  getOverlay(t, e) {
    return Zi(t)
      .get(zi(this.userId, e))
      .next((t) => (t ? Wi(this.O, t) : null));
  }
  getOverlays(t, e) {
    const n = zn(),
      s = [];
...
class tr {
  ...
  te(t, e) {
    if ("nullValue" in t) this.ne(e, 5);
    ...
    else if ("integerValue" in t) this.ne(e, 15), e.se(vt(t.integerValue));
      ...
      this.ne(e, 30), e.ue(St(t.bytesValue)), this.oe(e);
 ...
 */ class or {
  constructor() {
    (this.De = new sr()),
      (this.Ce = new ir(this.De)),
      (this.xe = new rr(this.De));
  }
  seed(t) {
    this.De.seed(t);
  }
...
function ar(t, e) {
  ...
  return 0 !== n
    ? n
    : ((n = cr(t.arrayValue, e.arrayValue)),
      0 !== n
        ? n
        : ((n = cr(t.directionalValue, e.directionalValue)),
 ...
 */ class fr {
  ...
  add(t) {
    const e = t.lastSegment(),
      n = t.popLast(),
      s = this.index[e] || new mt(It.comparator),
      i = !s.has(n);
...
class _r {
   ...
   */ ze(t, e, n) {
    ...
    for (const r of le(t)) {
      const t = n[i++];
      for (const n of s)
        if (this.en(e, r.fieldPath) && Jt(t)) s = this.nn(s, r, t);
        else {
          const e = n.Ne(r.kind);
          tr.fe.Zt(t, e);
        }
            ...
            (function (t, e) {
              const n = e
                  ? new de(
                      ...
                      new me(
                        qi(e.readTime),
                        new $t(Hs(e.documentKey)),
                        e.largestBatchId
                      )
                    )
                  : de.empty(),
                s = t.fields.map(([t, e]) => new fe(Et.fromServerFormat(t), e));
  ...
  updateIndexEntries(t, e) {
    ...
    return Ti.forEach(e, (e, s) => {
      ...
      return (
        i ? Ti.resolve(i) : this.getFieldIndexes(t, e.collectionGroup)
      ).next(
        (i) => (
    ...
    if (null != i) {
      ...
      if (Jt(r))
        for (const i of r.arrayValue.values || [])
          n = n.add(new ur(e.indexId, t.key, this.Je(i), s));
  ...
  getMinOffset(t, e) {
    ...
    return Ti.forEach(this.Qe(e), (e) =>
      this.je(t, e).next((t) => {
        t
          ? (!n || ge(t.indexState.offset, n) < 0) && (n = t.indexState.offset)
          : (n = me.min());
      })
    ).next(() => n);
  }
...
class Ir {
  ...
  static withCacheSize(t) {
    return new Ir(
      t,
      Ir.DEFAULT_COLLECTION_PERCENTILE,
      Ir.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT
    );
  }
}
...
/** A mutation queue for a specific user, backed by IndexedDB. */ (Ir.DEFAULT_COLLECTION_PERCENTILE = 10),
  (Ir.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
  (Ir.DEFAULT = new Ir(
    41943040,
    Ir.DEFAULT_COLLECTION_PERCENTILE,
    Ir.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT
...
class Ar {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    return r.add({}).next((o) => {
      ...
      const u = new Ni(o, e, n, s),
        a = (function (t, e, n) {
          const s = n.baseMutations.map((e) => Ds(t.Jt, e)),
            i = n.mutations.map((e) => Ds(t.Jt, e));
          return {
            userId: e,
            batchId: n.batchId,
  ...
  lookupMutationBatch(t, e) {
    return Pr(t)
      .get(e)
      .next((t) => (t ? (U(t.userId === this.userId), Ki(this.O, t)) : null));
  }
  /**
  ...
  getNextMutationBatchAfterBatchId(t, e) {
    ...
    return Pr(t)
      .Wt(
        ...
        (t, e, s) => {
          e.userId === this.userId && (U(e.batchId >= n), (i = Ki(this.O, e))),
            s.done();
        }
      )
      .next(() => i);
  ...
  getAllMutationBatches(t) {
    ...
    return Pr(t)
      ...
      .next((t) => t.map((t) => Ki(this.O, t)));
  }
  getAllMutationBatchesAffectingDocumentKey(t, e) {
    // Scan the document-mutation index starting with a prefix starting with
    // the given documentKey.
    const n = Ys(this.userId, e.path),
  ...
  removeMutationBatch(t, e) {
    return Tr(t.Ht, this.userId, e).next(
      (n) => (
        t.addOnCommittedListener(() => {
          this._n(e.batchId);
        }),
...
class $r {
   ...
   */ Mn(t, e) {
    return (function (t, e) {
      let n = !1;
      return Vr(t)
        .zt((s) => Rr(t, s, e).next((t) => (t && (n = !0), Ti.resolve(!t))))
        .next(() => n);
    })(t, e);
  }
  removeOrphanedDocuments(t, e) {
          ...
          if (!e)
            ...
            return (
              ...
              n
                ...
                .next(
                  () => (
                    n.removeEntry(r, ct.min()), xr(t).delete([0, js(r.path)])
                  )
                )
            );
        });
 ...
 */ class Lr {
   ...
   */ removeEntry(t, e) {
    this.assertNotApplied(),
      this.changes.set(t, ae.newInvalidDocument(t).setReadTime(e));
  }
  /**
 ...
 */ class Ur {
  ...
  Ln(t, e, n) {
    ...
    const i = IDBKeyRange.bound(jr(s.first()), jr(s.last())),
      r = s.getIterator();
    let o = r.getNext();
    return Qr(t)
      .Wt(
 ...
 */ class Kr extends Lr {
  ...
  applyChanges(t) {
    const e = [];
    let n = 0,
      s = new mt((t, e) => rt(t.canonicalString(), e.canonicalString()));
    return (
 ...
 */ class Jr {
   ...
   */ zn(t, e) {
    let n = null;
    return this.Wn.getOverlay(t, e)
      .next((s) => ((n = s), this.Hn(t, e, n)))
      .next((t) => (null !== n && vn(n.mutation, t, At.empty(), at.now()), t));
  }
  /**
   ...
   */ Yn(t, e, n = Zn()) {
    const s = zn();
    return this.Xn(t, s, e).next(() =>
      this.Zn(t, e, s, n).next((t) => {
        let e = Wn();
        return (
          t.forEach((t, n) => {
   ...
   */ Zn(t, e, n, s) {
    ...
    return (
      e.forEach((t, e) => {
        ...
        s.has(e.key) && (void 0 === o || o.mutation instanceof xn)
          ? (i = i.insert(e.key, e))
          : void 0 !== o &&
            (r.set(e.key, o.mutation.getFieldMask()),
            vn(o.mutation, e, o.mutation.getFieldMask(), at.now()));
      }),
      this.es(t, i).next(
        (t) => (
          t.forEach((t, e) => r.set(t, e)),
          e.forEach((t, e) => {
            var n;
            return o.set(
              t,
              new Hr(e, null !== (n = r.get(t)) && void 0 !== n ? n : null)
            );
          }),
          o
        )
  ...
  us(t, e, n) {
    ...
    let s;
    return this.Qn.getAllFromCollection(t, e.path, n)
      .next(
        (i) => (
          (s = i), this.Wn.getOverlaysForCollection(t, e.path, n.largestBatchId)
        )
      )
      .next((t) => {
  ...
  /** Returns a base document that can be used to apply `overlay`. */ Hn(
    t,
    e,
    n
  ) {
    return null === n || n.mutation instanceof xn
      ? this.Qn.getEntry(t, e)
      : Ti.resolve(ae.newInvalidDocument(e));
  }
}
 ...
 */ class Xr {
  ...
  Xt(t, e, n) {
    ...
    let i = this.ls.get(e);
    void 0 === i && ((i = Zn()), this.ls.set(e, i)),
      this.ls.set(e, i.add(n.key));
  }
}
 ...
 */ class Zr {
   ...
   * removed.
   */ Is(t) {
    const e = new $t(new It([])),
      n = new to(e, t),
      s = new to(e, t + 1),
      i = [];
    return (
      this._s.forEachInRange([n, s], (t) => {
 ...
 */ class eo {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    for (const e of s)
      (this.Ps = this.Ps.add(new to(e.key, i))),
  ...
  getEntries(t, e) {
    ...
    return (
      e.forEach((t) => {
        ...
        n = n.insert(
          t,
          e ? e.document.mutableCopy() : ae.newInvalidDocument(t)
        );
      }),
      Ti.resolve(n)
    );
 ...
 */ class io {
  ...
  allocateTargetId(t) {
    return (
      (this.highestTargetId = this.Os.next()), Ti.resolve(this.highestTargetId)
    );
  }
  setTargetsMetadata(t, e, n) {
    return (
  ...
  Tn(t) {
    ...
    e > this.highestTargetId &&
      ((this.Os = new vr(e)), (this.highestTargetId = e)),
      t.sequenceNumber > this.Ns && (this.Ns = t.sequenceNumber);
  }
  addTargetData(t, e) {
  ...
  removeTargetData(t, e) {
    return (
      this.xs.delete(e.target),
      this.ks.Is(e.targetId),
      (this.targetCount -= 1),
      Ti.resolve()
    );
  }
...
class ro {
  ...
  constructor(t, e) {
    (this.Ms = {}),
      ...
      (this.Bs = new io(this));
    (this.indexManager = new lr()),
      (this.Qn = (function (t) {
        return new no(t);
      })((t) => this.referenceDelegate.Ls(t))),
      (this.O = new Fi(e)),
      (this.Us = new Yr(this.O));
  }
  start() {
  ...
  getMutationQueue(t, e) {
    ...
    return (
      n || ((n = new eo(e, this.referenceDelegate)), (this.Ms[t.toKey()] = n)),
      n
    );
  }
  getTargetCache() {
  ...
  runTransaction(t, e, n) {
    ...
    return (
      ...
      n(s)
        .next((t) => this.referenceDelegate.Ks(s).next(() => t))
        .toPromise()
...
class uo {
  ...
  addReference(t, e, n) {
    return (
      this.Qs.addReference(n, e), this.zs.delete(n.toString()), Ti.resolve()
    );
  }
  removeReference(t, e, n) {
    return (
      this.Qs.removeReference(n, e), this.zs.add(n.toString()), Ti.resolve()
    );
  }
  markPotentiallyOrphaned(t, e) {
  ...
  Hs(t, e) {
    return Ti.or([
      () => Ti.resolve(this.Qs.containsKey(e)),
...
/** Performs database creation and schema upgrades. */ class ao {
   ...
   */ kt(t, e, n, s) {
    ...
    return (
      ...
      n < 7 && s >= 7 && (r = r.next(() => this.Xs(i))),
      n < 8 && s >= 8 && (r = r.next(() => this.Zs(t, i))),
      n < 9 &&
        s >= 9 &&
        (r = r.next(() => {
        ...
        (r = r
          .next(() =>
            (function (t) {
              ...
              e.createIndex("documentKeyIndex", ei),
                e.createIndex("collectionGroupIndex", ni);
            })(t)
          )
          .next(() => this.ei(t, i))
          .next(() => t.deleteObjectStore("remoteDocuments"))),
      n < 14 && s >= 14 && (r = r.next(() => this.ni(t, i))),
      n < 15 &&
        s >= 15 &&
        (r = r.next(() =>
          (function (t) {
    ...
    return n
      .Wt((t, n) => {
        const i = e.store("remoteDocumentsV14"),
          r = ((o = n),
          o.document
            ? new $t(It.fromString(o.document.name).popFirst(5))
            : o.noDocument
            ? $t.fromSegments(o.noDocument.path)
            : o.unknownDocument
            ? $t.fromSegments(o.unknownDocument.path)
            : L()).path.toArray();
        var o;
        /**
         * @license
      ...
      .next(() => {
        o.forEach((t, n) => {
          const o = new C(n),
            ...
            c = Ar.Yt(o, this.O, a, i.referenceDelegate),
            h = new Jr(s, c, u, a);
...
class lo {
  constructor(
    ...
    (this.referenceDelegate = new $r(this, s)),
      (this.fi = e + "main"),
      (this.O = new Fi(u)),
      (this.di = new Ai(this.fi, this.oi, new ao(this.O))),
      (this.Bs = new Sr(this.referenceDelegate, this.O)),
      (this.Qn = qr(this.O)),
      (this.Us = new Hi()),
      ...
      .then(() => {
        ...
        return (
          ...
          this.runTransaction(
            ...
            "readonly",
            (t) => this.Bs.getHighestSequenceNumber(t)
          )
        );
      })
      .then((t) => {
    ...
    return this.runTransaction(
      ...
      .catch((t) => {
        if (bi(t))
          ...
          return (
            M("IndexedDbPersistence", "Failed to extend owner lease: ", t),
            this.isPrimary
          );
      ...
      .then((t) => {
        this.isPrimary !== t && this.si.enqueueRetryable(() => this.li(t)),
          (this.isPrimary = t);
      });
  }
  Ii(t) {
   ...
   */ Oi() {
    return this.runTransaction("getActiveClients", "readonly", (t) =>
      _o(t)
        .qt()
        .next((t) => this.vi(t, 18e5).map((t) => t.clientId))
    );
  }
  get started() {
    return this.$s;
  ...
  runTransaction(t, e, n) {
    ...
    return this.di
      .runTransaction(
        ...
        i,
        (s) => (
          (o = new Ci(s, this.Fs ? this.Fs.next() : nt.A)),
          "readwrite-primary" === e
            ? this.Ii(o)
                .next((t) => !!t || this.Ti(o))
                .next((e) => {
                  if (!e)
                    throw (
                      ...
                      (this.isPrimary = !1),
                      this.si.enqueueRetryable(() => this.li(!1)),
                      new Q(G.FAILED_PRECONDITION, pi))
                    );
                  return n(o);
                })
                .next((t) => this.Ai(o).next(() => t))
            : this.Mi(o).next(() => n(o))
        )
      )
  ...
  /** Checks the primary lease and removes it if we are the current primary. */ Ei(
    t
  ) {
    const e = fo(t);
    return e
      ...
      ((this.ui = () => {
        ...
        this.Ci(),
          isSafari() &&
            ...
            this.si.enterRestrictedMode(/* purgeExistingTasks= */ !0),
 ...
 */ class go {
  ...
  /** Returns all local documents matching the specified query. */ ss(
    t,
    e,
    n,
    s
    ...
    return this.qi(t, e)
      .next((i) => i || this.Ki(t, e, s, n))
      .next((n) => n || this.Gi(t, e));
  }
  /**
   ...
   */ Ki(t, e, n, s) {
    return Ge(e) || s.isEqual(ct.min())
      ? this.Gi(t, e)
      : this.Ui.Jn(t, n).next((i) => {
          const r = this.Qi(e, i);
          return this.ji(e, r, n, s)
            ? this.Gi(t, e)
            : (k() <= LogLevel.DEBUG &&
                M(
                  "QueryEngine",
  ...
  /** Applies the query filter and sorting to the provided documents.  */ Qi(
    t,
    e
  ) {
  ...
  Gi(t, e) {
    return (
      k() <= LogLevel.DEBUG &&
        M("QueryEngine", "Using full collection scan to execute query:", Ze(e)),
...
class yo {
  constructor(
    ...
    (this.persistence = t),
       ...
       */
      (this.Yi = new Map()),
      (this.Xi = t.getRemoteDocumentCache()),
      (this.Bs = t.getTargetCache()),
      (this.Us = t.getBundleCache()),
      this.Zi(n);
  }
  Zi(t) {
    // TODO(indexing): Add spec tests that test these components change after a
    // user change
    (this.Wn = this.persistence.getDocumentOverlayCache(t)),
      (this.indexManager = this.persistence.getIndexManager(t)),
      (this.jn = this.persistence.getMutationQueue(t, this.indexManager)),
      (this.tr = new Jr(this.Xi, this.jn, this.Wn, this.indexManager)),
...
async function Io(t, e) {
  ...
  return await n.persistence.runTransaction(
    ...
    (t) => {
      ...
      return n.jn
        .getAllMutationBatches(t)
        .next((i) => ((s = i), n.Zi(e), n.jn.getAllMutationBatches(t)))
        .next((e) => {
          const i = [],
            r = [];
  ...
  return n.persistence.runTransaction(
    ...
    (t) => {
      ...
      return (function (t, e, n, s) {
        ...
        .next(() => i.apply(t))
        .next(() => n.jn.performConsistencyCheck(t))
        .next(() => n.Wn.removeOverlaysForBatchId(t, s, e.batch.batchId))
        .next(() =>
          n.tr.ns(
            t,
            (function (t) {
...
function Eo(t) {
  ...
  return e.persistence.runTransaction(
    ...
    "readonly",
    (t) => e.Bs.getLastRemoteSnapshotVersion(t)
  );
}
  ...
  return n.persistence
    .runTransaction("Apply remote event", "readwrite-primary", (t) => {
      ...
      e.targetChanges.forEach((r, u) => {
        ...
        o.push(
          n.Bs.removeMatchingKeys(t, r.removedDocuments, u).next(() =>
            n.Bs.addMatchingKeys(t, r.addedDocuments, u)
          )
        );
        ...
        e.targetMismatches.has(u)
          ...
          (function (t, e, n) {
            ...
            c,
            r
          ) && o.push(n.Bs.updateTargetData(t, c));
      });
      let u = Qn(),
        a = Zn();
      ...
      if (
        ...
        o.push(
          Ro(t, r, e.documentUpdates).next((t) => {
            (u = t.nr), (a = t.sr);
          })
        ),
        !s.isEqual(ct.min()))
      ) {
        const e = n.Bs.getLastRemoteSnapshotVersion(t).next((e) =>
          n.Bs.setTargetsMetadata(t, t.currentSequenceNumber, s)
        );
        o.push(e);
      }
      return Ti.waitFor(o)
          ...
          r.isFoundDocument() !== o.isFoundDocument() && (i = i.add(n)),
            ...
            r.isNoDocument() && r.version.isEqual(ct.min())
              ? // NoDocuments with SnapshotVersion.min() are used in manufactured
                ...
                // access.
                (e.removeEntry(n, r.readTime), (s = s.insert(n, r)))
              : !o.isValidDocument() ||
                r.version.compareTo(o.version) > 0 ||
                (0 === r.version.compareTo(o.version) && o.hasPendingWrites)
              ? (e.addEntry(r), (s = s.insert(n, r)))
              : M(
                  "LocalStore",
...
function Po(t, e) {
  ...
  return n.persistence.runTransaction(
    ...
    "readonly",
    (t) => (
      void 0 === e && (e = -1), n.jn.getNextMutationBatchAfterBatchId(t, e)
    )
  );
}
...
function bo(t, e) {
  ...
  return n.persistence
    .runTransaction("Allocate target", "readwrite", (t) => {
      let s;
      return n.Bs.getTargetData(t, e).next((i) =>
        i
          ? // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            ((s = i), Ti.resolve(s))
          : n.Bs.allocateTargetId(t).next(
              (i) => (
                (s = new Mi(e, i, 0 /* Listen */, t.currentSequenceNumber)),
    ...
    .then((t) => {
      ...
      return (
        (null === s || t.snapshotVersion.compareTo(s.snapshotVersion) > 0) &&
          ((n.Hi = n.Hi.insert(t.targetId, t)), n.Ji.set(e, t.targetId)),
        t
      );
    });
}
      ...
      .next((e) => {
        if (e)
          return (
            ...
            s.Bs.getMatchingKeysForTargetId(t, e.targetId).next((t) => {
              r = t;
            })
          );
      })
      .next(() => s.zi.ss(t, e, n ? i : ct.min(), n ? r : Zn()))
      .next(
        (t) => (
          Co(s, en(e), t),
          {
  ...
  return i.persistence.runTransaction(
    ...
    (t) =>
      Ro(t, u, o)
        .next((e) => (u.apply(t), e))
        .next((e) =>
          i.Bs.removeMatchingKeysForTargetId(t, a.targetId)
            .next(() => i.Bs.addMatchingKeys(t, r, a.targetId))
            .next(() => i.tr.Yn(t, e.nr, e.sr))
            .next(() => e.nr)
        )
  );
}
...
async function No(t, e, n = Zn()) {
  ...
  const s = await bo(t, He(ji(e.bundledQuery))),
    i = K(t);
  return i.persistence.runTransaction("Save named query", "readwrite", (t) => {
    ...
    return (
      (i.Hi = i.Hi.insert(o.targetId, o)),
      i.Bs.updateTargetData(t, o)
        .next(() => i.Bs.removeMatchingKeysForTargetId(t, s.targetId))
        .next(() => i.Bs.addMatchingKeys(t, n, s.targetId))
        .next(() => i.Us.saveNamedQuery(t, e))
    );
  });
}
 ...
 */ class Bo {
   ...
   */ static cr(t, e) {
    ...
    for (let t = 0; s && t < n.activeTargetIds.length; ++t)
      (s = Ft(n.activeTargetIds[t])), (i = i.add(n.activeTargetIds[t]));
    return s
      ? new Bo(t, i)
      : (F(
          "SharedClientState",
 ...
 */ class Lo {
   ...
   */ static cr(t) {
    ...
    return "object" == typeof e &&
      ...
      ? new Lo(e.clientId, e.onlineState)
 ...
 */ class qo {
  constructor(t, e, n, s, i) {
    ...
    (this.storage = this.window.localStorage),
      (this.currentUser = i),
      (this.pr = ko(this.persistenceKey, this._r)),
      (this.Ir =
      ...
      (this.gr = this.gr.insert(this._r, new Uo())),
      (this.Tr = new RegExp(`^firestore_clients_${r}_([^_]*)$`)),
      (this.Er = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`)),
      (this.Ar = new RegExp(`^firestore_targets_${r}_(\\d+)$`)),
      (this.Rr =
  ...
  mr(t) {
    ...
    if (e.storageArea === this.storage) {
      if (
        (M("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.pr)
      )
        return void F(
  ...
  kr(t, e, n) {
    const s = Mo(this.persistenceKey, t),
      i = new $o(t, e, n);
    this.setItem(s, i.hr());
  }
  Mr(t) {
  ...
  $r(t, e) {
    const n = e ? this.gr.insert(t, e) : this.gr.remove(t),
      s = this.Sr(this.gr),
      i = this.Sr(n),
      r = [],
      o = [];
 ...
 */ class zo
  ...
  extends class {
    ...
    po(t, e, n, s, i) {
      ...
      return (
        this.To(o, s, i),
        this.Eo(t, r, o, n).then(
          (t) => (M("RestConnection", "Received: ", t), t),
          (e) => {
            throw (
              ($(
                "RestConnection",
  ...
  }
{
  ...
  Ro(t, e, n) {
    ...
    this.useFetchStreams && (o.xmlHttpFactory = new FetchXmlHttpFactory({})),
      this.To(o.initMessageHeaders, e, n),
    ...
    const l = new Wo({
        ro: (t) => {
          h
            ? M("Connection", "Not sending because WebChannel is closed:", t)
            : (c ||
                (M("Connection", "Opening WebChannel transport."),
                a.open(),
                (c = !0)),
              M("Connection", "WebChannel sending:", t),
              a.send(t));
        },
        oo: () => a.close(),
      }),
    ...
    return (
      ...
      y(a, WebChannel.EventType.ERROR, (t) => {
        h ||
          ...
          l._o(new Q(G.UNAVAILABLE, "The operation could not be completed")));
      }),
      ...
      y(r, Event.STAT_EVENT, (t) => {
        t.stat === Stat.PROXY
          ? M("Connection", "Detected buffering proxy")
          : t.stat === Stat.NOPROXY &&
            M("Connection", "Detected no buffering proxy");
      }),
      setTimeout(() => {
...
class Xo {
   ...
   */ xo(t) {
    ...
    // honored as such).
    const e = Math.floor(this.vo + this.No()),
    ...
    s > 0 &&
      M(
        "ExponentialBackoff",
        `Backing off for ${s} ms (base delay: ${this.vo} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`
      ),
...
class Zo {
   ...
   */ jo() {
    ...
    this.Ko() &&
      null === this.Bo &&
      (this.Bo = this.si.enqueueAfterDelay(this.Oo, 6e4, () => this.Wo()));
  }
        ...
        n(
          () => (
            ...
            (this.Lo = this.si.enqueueAfterDelay(
              ...
              1e4,
              () => (
                this.Ko() && (this.state = 3) /* Healthy */, Promise.resolve()
              )
            )),
            this.listener.uo()
          )
  ...
  tu(t) {
    ...
    return (
      M("PersistentStream", `close with error: ${t}`),
      (this.stream = null),
      ...
      (e.addTarget = (function (t, e) {
        ...
        return (
          ...
          e.resumeToken.approximateByteSize() > 0
            ? (n.resumeToken = ws(t, e.resumeToken))
            : e.snapshotVersion.compareTo(ct.min()) > 0 &&
              // TODO(wuandy): Consider removing above check because it is most likely true.
              // Right now, many tests depend on this behaviour though (leaving min() out
              // of serialization).
              (n.readTime = _s(t, e.snapshotVersion.toTimestamp())),
          n
        );
      })(this.O, t));
    const n = Ms(this.O, t);
 ...
 */ class eu extends Zo {
  ...
  onMessage(t) {
    if (
      ...
      this.Uo.reset();
      const e = xs(t.writeResults, t.commitTime),
        n = gs(t.commitTime);
...
class nu extends class {} {
  ...
  /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ Ao(
    t,
    e,
    n
  ) {
        ...
        n.enqueueAndForget(async () => {
          ...
          du(this) &&
            ...
            await (async function (t) {
              const e = K(t);
              e.Au.add(4 /* ConnectivityChange */),
                await ou(e),
                e.bu.set("Unknown" /* Unknown */),
                e.Au.delete(4 /* ConnectivityChange */),
                await ru(e);
            })(this));
        });
      }),
...
async function gu(t, e, n) {
  if (
    ...
    (t.bu.set("Online" /* Online */),
    e instanceof os && 2 /* Removed */ === e.state && e.cause)
  )
    ...
    (e instanceof is ? t.Vu.ut(e) : e instanceof rs ? t.Vu._t(e) : t.Vu.ht(e),
    !n.isEqual(ct.min()))
  )
    try {
  ...
  e &&
    ...
    (await (async function (t, e) {
      ...
      if (((n = e.code), Un(n) && n !== G.ABORTED)) {
        ...
        // restart.
        xu(t).Qo(),
          await pu(t, () => t.remoteSyncer.rejectFailedWrite(n.batchId, e)),
...
async function Su(t, e) {
  ...
  n.Au.add(3 /* CredentialChange */),
    await ou(n),
    s &&
      // Don't set the network status to Unknown if we are offline.
      n.bu.set("Unknown" /* Unknown */),
    await n.remoteSyncer.handleCredentialChange(e),
    n.Au.delete(3 /* CredentialChange */),
    await ru(n);
}
 ...
 */ async function Du(t, e) {
  const n = K(t);
  e
    ? (n.Au.delete(2 /* IsSecondary */), await ru(n))
    : e ||
      (n.Au.add(2 /* IsSecondary */),
      await ou(n),
      n.bu.set("Unknown" /* Unknown */));
}
  ...
  return (
    t.vu ||
      ...
      ((t.vu = (function (t, e, n) {
        ...
        return (
          s.fu(),
          new tu(e, s.Fo, s.authCredentials, s.appCheckCredentials, s.O, n)
        );
      })(
        /**
         * @license
      ...
      t.Ru.push(async (e) => {
        e
          ? (t.vu.Qo(), fu(t) ? lu(t) : t.bu.set("Unknown" /* Unknown */))
          : (await t.vu.stop(), _u(t));
      })),
    t.vu
  );
}
  ...
  return (
    t.Su ||
      ...
      ((t.Su = (function (t, e, n) {
        ...
        return (
          s.fu(),
          new eu(e, s.Fo, s.authCredentials, s.appCheckCredentials, s.O, n)
        );
 ...
 */ class Ou {
  ...
  constructor(t) {
    ...
    (this.comparator = t
      ? (e, n) => t(e, n) || $t.comparator(e.key, n.key)
      : (t, e) => $t.comparator(t.key, e.key)),
      (this.keyedMap = Wn()),
 ...
 */ class Qu {
   ...
   */ Ou(t) {
    ...
    return (
      this.Fu
        ? this.Bu(t) && (this.Mu.next(t), (e = !0))
        : this.Lu(t, this.onlineState) && (this.Uu(t), (e = !0)),
      (this.$u = t),
      e
    );
  }
  ...
  Uu(t) {
    (t = Fu.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache)),
      (this.Fu = !0),
      this.Mu.next(t);
  }
}
 ...
 */ class Wu {
   ...
   */ ur(t) {
    return t.metadata.exists
      ? Vs(this.O, t.document, !1)
      : ae.newNoDocument(
          this.rr(t.metadata.name),
          this.ar(t.metadata.readTime)
        );
  }
  ar(t) {
    return gs(t);
 ...
 */ class Xu {
        ...
        if (c && h) {
          c.data.isEqual(h.data)
            ...
            : this.sa(c, h) ||
              ...
              (d = !0),
              ((u && this.Xu(h, u) > 0) || (a && this.Xu(h, a) < 0)) &&
  ...
  applyChanges(t, e, n) {
    ...
    i.sort(
      ...
      this.ia(n);
    const r = e ? this.ra() : [],
      o = 0 === this.Yu.size && this.current ? 1 /* Synced */ : 0 /* Local */,
      u = o !== this.Ju;
   ...
   */ ua(t) {
    ...
    return (
      ...
      !!this.Zu.has(t) &&
      !this.Zu.get(t).hasLocalMutations
    );
  }
  /**
   ...
   */ ia(t) {
    t &&
      (t.addedDocuments.forEach((t) => (this.Hu = this.Hu.add(t))),
      t.modifiedDocuments.forEach((t) => {}),
      t.removedDocuments.forEach((t) => (this.Hu = this.Hu.delete(t))),
  ...
  // PORTING NOTE: Multi-tab only.
  ca() {
    return Fu.fromInitialDocuments(
      this.query,
      this.Zu,
      this.mutatedKeys,
      0 /* Local */ === this.Ju
 ...
 */ async function sa(t, e, n, s) {
  ...
  t.Ea = (e, n, s) =>
    (async function (t, e, n, s) {
      ...
      i.ji &&
        ...
        (i = await vo(t.localStore, e.query, /* usePreviousResults= */ !1).then(
          ({ documents: t }) => e.view.ea(t, i)
        ));
  ...
  const i = await vo(t.localStore, e, /* usePreviousResults= */ !0),
    r = new Xu(e, i.ir),
    o = r.ea(i.documents),
    u = ss.createSynthesizedTargetChangeForCurrentChange(
      n,
  ...
  return (
    t.fa.set(e, c),
    t.da.has(n) ? t.da.get(n).push(e) : t.da.set(n, [e]),
    a.snapshot
  );
}
...
/** Stops listening to the query. */ async function ia(t, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) ||
      (await Vo(n.localStore, s.targetId, /*keepPersistedTargetData=*/ !1)
        .then(() => {
          n.sharedClientState.clearQueryState(s.targetId),
            au(n.remoteStore, s.targetId),
            _a(n, s.targetId);
        })
        .catch(Nr));
  } else
    _a(n, s.targetId),
      await Vo(n.localStore, s.targetId, /*keepPersistedTargetData=*/ !0);
}
 ...
 */ async function ra(t, e, n) {
  ...
  try {
    const t = await (function (t, e) {
      ...
      return n.persistence
        ...
        .then(() => {
          let t = Wn();
          return (
            r.forEach((e, n) => (t = t.insert(e, n.overlayedDocument))),
            {
              batchId: o.batchId,
              changes: t,
            }
    ...
    s.sharedClientState.addPendingMutation(t.batchId),
      ...
      await pa(s, t.changes),
      await Iu(s.remoteStore);
  } catch (t) {
    ...
    e.targetChanges.forEach((t, e) => {
      ...
      s &&
        ...
        t.addedDocuments.size > 0
          ...
          ? U(s.ha)
          : t.removedDocuments.size > 0 && (U(s.ha), (s.ha = !1)));
    }),
      await pa(n, t, e);
  } catch (t) {
    await Nr(t);
    ...
    s.fa.forEach((n, s) => {
      ...
      (function (t, e) {
        ...
        n.queries.forEach((t, n) => {
          // Run global snapshot listeners if a consistent snapshot has been emitted.
          for (const t of n.listeners) t.ku(e) && (s = !0);
        }),
          s && Gu(n);
      })(s.eventManager, e),
      t.length && s.la.nu(t),
 ...
 */ async function aa(t, e, n) {
  ...
  if (r) {
    ...
    await Vo(s.localStore, e, /* keepPersistedTargetData */ !1)
      .then(() => _a(s, e, n))
      .catch(Nr);
}
      ...
      return n.persistence.runTransaction(
        ...
        (t) => {
          ...
          return n.jn
            ...
            .next(
              (e) => (
                U(null !== e), (s = e.keys()), n.jn.removeMutationBatch(t, e)
              )
            )
            .next(() => n.jn.performConsistencyCheck(t))
            .next(() => n.Wn.removeOverlaysForBatchId(t, s, e))
            .next(() => n.tr.ns(t, s))
            .next(() => n.tr.Jn(t, s));
        }
      );
  ...
  try {
    const t = await (function (t) {
      ...
      return e.persistence.runTransaction(
        ...
        "readonly",
        (t) => e.jn.getHighestUnacknowledgedBatchId(t)
      );
    })(n.localStore);
    if (-1 === t)
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function da(
  t,
  e,
  n
) {
...
function wa(t, e) {
  ...
  const n = t.wa.get(e);
  null !== n &&
    (au(t.remoteStore, n), (t.wa = t.wa.remove(e)), t.ma.delete(n), ya(t));
}

function ma(t, e, n) {
  for (const s of n)
    if (s instanceof Ju) t.ga.addReference(s.key, e), ga(t, s);
    else if (s instanceof Yu) {
      M("SyncEngine", "Document no longer in limbo: " + s.key),
        t.ga.removeReference(s.key, e);
...
function ga(t, e) {
  ...
  t.wa.get(n) ||
    t._a.has(s) ||
    (M("SyncEngine", "New document in limbo: " + n), t._a.add(s), ya(t));
}
 ...
 */ function ya(t) {
  for (; t._a.size > 0 && t.wa.size < t.maxConcurrentLimboResolutions; ) {
    ...
    t._a.delete(e);
    const n = new $t(It.fromString(e)),
      s = t.Ia.next();
    t.ma.set(s, new ta(n)),
      (t.wa = t.wa.insert(n, s)),
      uu(
        t.remoteStore,
        new Mi(He(Ke(n.path)), s, 2 /* LimboResolution */, nt.A)
      );
  }
}
 ...
 */ async function Ea(t, e) {
  const n = K(t),
    s = await vo(n.localStore, e.query, /* usePreviousResults= */ !0),
    i = e.view.aa(s);
  ...
  const i = K(t),
    r = await (function (t, e) {
      ...
      return n.persistence.runTransaction(
        ...
        "readonly",
        (t) => s.fn(t, e).next((e) => (e ? n.tr.Jn(t, e) : Ti.resolve(null)))
      );
    })(
      // PORTING NOTE: Multi-Tab only.
      i.localStore,
  ...
  if ((Ca(n), xa(n), !0 === e && !0 !== n.Ta)) {
    ...
    n.da.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i)
        ...
        : (e = e.then(
            () => (
              _a(n, i), Vo(n.localStore, i, /*keepPersistedTargetData=*/ !0)
            )
          )),
        au(n.remoteStore, i);
    }),
...
async function ba(t, e, n) {
  ...
  for (const t of e) {
    ...
    if (n && 0 !== n.length) {
      ...
      (e = await bo(s.localStore, n)), await sa(s, Va(n), t, /*current=*/ !1);
    }
    i.push(e);
  }
  return s.la.nu(r), i;
...
async function Sa(t, e, n, s) {
  ...
  if (r && r.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t = await Do(i.localStore, en(r[0])),
          s = ns.createSynthesizedRemoteEventForCurrentChange(
            e,
            "current" === n
          );
        await pa(i, t, s);
      ...
      case "rejected":
        await Vo(i.localStore, e, /* keepPersistedTargetData */ !0),
          _a(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Da(
  t,
  e,
  n
) {
  ...
  if (s.Ta) {
    for (const t of e) {
      ...
      const e = await So(s.localStore, t),
        n = await bo(s.localStore, e);
      await sa(s, Va(e), n.targetId, /*current=*/ !1), uu(s.remoteStore, n);
    }
    ...
    for (const t of n)
      s.da.has(t) &&
        ...
        (await Vo(s.localStore, t, /* keepPersistedTargetData */ !1)
          .then(() => {
...
function Ca(t) {
  const e = K(t);
  return (
    (e.remoteStore.remoteSyncer.applyRemoteEvent = oa.bind(null, e)),
    (e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Ta.bind(null, e)),
    (e.remoteStore.remoteSyncer.rejectListen = aa.bind(null, e)),
    (e.la.nu = qu.bind(null, e.eventManager)),
    (e.la.Aa = Ku.bind(null, e.eventManager)),
    e
  );
}
...
function xa(t) {
  const e = K(t);
  return (
    (e.remoteStore.remoteSyncer.applySuccessfulWrite = ca.bind(null, e)),
    (e.remoteStore.remoteSyncer.rejectFailedWrite = ha.bind(null, e)),
    e
  );
}
...
class ka {
  ...
  async initialize(t) {
    (this.O = Yo(t.databaseInfo.databaseId)),
      (this.sharedClientState = this.Pa(t)),
      (this.persistence = this.ba(t)),
      await this.persistence.start(),
      (this.gcScheduler = this.Va(t)),
      (this.localStore = this.va(t));
  }
  Va(t) {
    return null;
  }
 ...
 */ class Oa extends ka {
  ...
  async initialize(t) {
    await super.initialize(t),
      await this.Sa.initialize(this, t),
      // Enqueue writes from a previous session
      await xa(this.Sa.syncEngine),
      await Iu(this.Sa.remoteStore),
  ...
  ba(t) {
    const e = wo(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey),
      n =
        void 0 !== this.cacheSizeBytes
          ? Ir.withCacheSize(this.cacheSizeBytes)
          : Ir.DEFAULT;
    return new lo(
 ...
 */ class Ma extends Oa {
  ...
  async initialize(t) {
    ...
    this.sharedClientState instanceof qo &&
 ...
 */ class Fa {
  async initialize(t, e) {
    this.localStore ||
      ...
      (this.sharedClientState.onlineStateHandler = (t) =>
        ua(this.syncEngine, t, 1 /* SharedClientState */)),
      (this.remoteStore.remoteSyncer.handleCredentialChange = Ia.bind(
        null,
        this.syncEngine
      )),
  ...
  createRemoteStore(t) {
    return (
      ...
      (n = this.datastore),
      (s = t.asyncQueue),
      (i = (t) => ua(this.syncEngine, t, 0 /* RemoteStore */)),
      (r = Qo.vt() ? new Qo() : new Go()),
      new iu(e, n, s, i, r)
    );
    var e, n, s, i, r;
 ...
 */ class La {
   ...
   */ async Oa() {
    ...
    t < 0 &&
      this.Ma("Reached the end of bundle when a length string is expected.");
...
class Ua {
  ...
  async lookup(t) {
    ...
    const e = await (async function (t, e) {
      const n = K(t),
        ...
        r = await n.Ao("BatchGetDocuments", s, i),
        o = new Map();
      r.forEach((t) => {
        const e = vs(n.O, t);
  ...
  delete(t) {
    this.write(new Mn(t, this.precondition(t))),
      this.writtenDocs.add(t.toString());
  }
  async commit() {
 ...
 */ class qa {
  ...
  Ka(t) {
    this.La > 0 && this.Ga(t)
      ? ((this.La -= 1),
        this.asyncQueue.enqueueAndForget(() => (this.Ua(), Promise.resolve())))
  ...
  constructor(
    ...
    (this.authCredentials = t),
      ...
      this.appCheckCredentials.start(
        n,
        (t) => (
          M("FirestoreClient", "Received new app check token=", t),
...
async function Qa(t, e) {
  ...
  await e.initialize(n, s),
    ...
    t.setCredentialChangeListener((t) => Su(e.remoteStore, t)),
    t.setAppCheckTokenChangeListener((t, n) => Su(e.remoteStore, n)),
...
async function Xa(t) {
  const e = await Wa(t),
    n = e.eventManager;
  return (
    (n.onListen = na.bind(null, e.syncEngine)),
    (n.onUnlisten = ia.bind(null, e.syncEngine)),
    n
  );
}
...
/** Disables the network connection. Pending operations will not complete. */ function tc(
  t
) {
  return t.asyncQueue.enqueue(async () => {
    const e = await za(t),
...
function sc(t, e) {
  ...
  return (
    t.asyncQueue.enqueueAndForget(async () =>
      (async function (t, e, n) {
        try {
          const s = await vo(t, e, /* usePreviousResults= */ !0),
            i = new Xu(e, s.ir),
            r = i.ea(s.documents),
 ...
 */ class Ec extends Tc {
   ...
   */ get parent() {
    ...
    return t.isEmpty()
      ? null
      : new Ic(this.firestore, /* converter= */ null, new $t(t));
  }
  withConverter(t) {
...
function Ac(t, e, ...n) {
  if (
    ((t = getModularInstance(t)), hc("collection", "path", e), t instanceof yc)
  ) {
    const s = It.fromString(e, ...n);
    return dc(s), new Ec(t, /* converter= */ null, s);
  }
  {
    if (!(t instanceof Ic || t instanceof Ec))
      throw new Q(
        G.INVALID_ARGUMENT,
        "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore"
      );
    const s = t._path.child(It.fromString(e, ...n));
    return dc(s), new Ec(t.firestore, /* converter= */ null, s);
  }
}
 ...
 */ function Rc(t, e) {
  if (
    ((t = wc(t, yc)),
    hc("collectionGroup", "collection id", e),
    e.indexOf("/") >= 0)
  )
    throw new Q(
      G.INVALID_ARGUMENT,
...
function Pc(t, e, ...n) {
  if (
    ...
    const s = It.fromString(e, ...n);
    return fc(s), new Ic(t, /* converter= */ null, new $t(s));
  }
  {
    if (!(t instanceof Ic || t instanceof Ec))
      throw new Q(
    ...
    return (
      fc(s),
      new Ic(t.firestore, t instanceof Ec ? t.converter : null, new $t(s))
    );
  }
}
 ...
 */ function bc(t, e) {
  return (
    ...
    (t instanceof Ic || t instanceof Ec) &&
      (e instanceof Ic || e instanceof Ec) &&
  ...
  constructor() {
    ...
    (this.Qa = Promise.resolve()),
      ...
      (this.Za = () => {
        const t = Jo();
        t &&
          M("AsyncQueue", "Visibility state changed to " + t.visibilityState),
          this.Uo.ko();
      });
    const t = Jo();
    t &&
      "function" == typeof t.addEventListener &&
      t.addEventListener("visibilitychange", this.Za);
  }
  get isShuttingDown() {
    return this.Wa;
  }
  ...
  enterRestrictedMode(t) {
    if (!this.Wa) {
      ...
      e &&
        ...
        e.removeEventListener("visibilitychange", this.Za);
    }
  }
  enqueue(t) {
    if ((this.tc(), this.Wa))
 ...
 */ function Fc(t, e) {
  ...
  return Bc(
    n,
    i,
    new Oa(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership)
  );
}
    ...
    t._queue.enqueueAndForgetEvenWhileRestricted(async () => {
      try {
        await (async function (t) {
          ...
          const e = t + "main";
          await Ai.delete(e);
        })(wo(t._databaseId, t._persistenceKey)),
          e.resolve();
      } catch (t) {
        e.reject(t);
      }
 ...
 */ function Uc(t) {
  return (function (t) {
    const e = new j();
    return (
      t.asyncQueue.enqueueAndForget(async () => la(await Ya(t), e)), e.promise
    );
  })(Oc((t = wc(t, xc))));
}
 ...
 */ function jc(t, e) {
  return ac(Oc((t = wc(t, xc))), e).then((e) =>
    e ? new Tc(t, null, e.query) : null
  );
}
...
/** A "context" object passed around while parsing user data. */ class sh {
  ...
  ac() {
    ...
    // within arrays.
    if (this.path)
      for (let t = 0; t < this.path.length; t++) this.dc(this.path.get(t));
  }
  dc(t) {
    if (0 === t.length) throw this.mc("Document fields must not be empty");
    if (nh(this.cc) && Zc.test(t))
...
/** Parse document data from a set() call. */ function oh(
  t,
  e,
  n,
  s,
  ...
  const u = gh(s, o);
  let a, c;
  if (r.merge) (a = new At(o.fieldMask)), (c = o.fieldTransforms);
...
class hh extends Yc {
  ...
  _toFieldTransform(t) {
    const e = ah(this, t, /*array=*/ !0),
      n = this.Tc.map((t) => mh(t, e)),
      s = new dn(n);
...
/** Parse update data from a list of field/value arguments. */ function _h(
  t,
  e,
  n,
  s,
 ...
 */ function mh(t, e) {
  if (
    ...
    return ph("Unsupported field value:", e, t), gh(t, e);
  if (t instanceof Yc)
  ...
  if (
    ...
    if (e.settings.fc && 4 /* ArrayArgument */ !== e.cc)
 ...
 */ function Ih(t, e, n) {
  if (
    ...
    // FieldPath.
    (e = getModularInstance(e)) instanceof zc
  )
...
/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function Rh(
  t,
  e
) {
 ...
 */ class Ch {
  ...
  constructor(t, e, n, s) {
    (this._firestore = t),
      (this._userDataWriter = e),
      (this._snapshot = s),
      (this.metadata = new vh(s.hasPendingWrites, s.fromCache)),
      (this.query = n);
  }
 ...
 */ function Nh(t, e) {
  return t instanceof Sh && e instanceof Sh
...
function Qh(...t) {
  return new Gh("startAt", t, /*inclusive=*/ !0);
}

function jh(...t) {
  return new Gh("startAfter", t, /*inclusive=*/ !1);
}
...
function zh(...t) {
  return new Wh("endBefore", t, /*inclusive=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Jh(
  t,
  e,
  n,
  s
  ...
  if (((n[0] = getModularInstance(n[0])), n[0] instanceof Ph))
    return (function (t, e, n, s, i) {
      ...
      // results.
      for (const n of ze(t))
        if (n.field.isKeyField()) r.push(zt(e, s.key));
        else {
...
function Yh(t, e, n) {
  ...
  throw new Q(
    G.INVALID_ARGUMENT,
    `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${_c(
      n
    )}.`
  );
}
...
class el {
  ...
  convertDocumentKey(t, e) {
    ...
    U(Qs(n));
    const s = new kt(n.get(1), n.get(3)),
      i = new $t(n.popFirst(5));
    return (
      s.isEqual(e) ||
 ...
 */ class il {
  ...
  set(t, e, n) {
    ...
    const s = rl(t, this._firestore),
      i = nl(s.converter, e, n),
      r = oh(
        this._dataReader,
        "WriteBatch.set",
        s._key,
  ...
  update(t, e, n, ...s) {
    ...
    return (
      (r =
        "string" == typeof (e = getModularInstance(e)) || e instanceof zc
          ? _h(this._dataReader, "WriteBatch.update", i._key, e, n, s)
          : dh(this._dataReader, "WriteBatch.update", i._key, e)),
   ...
   */ delete(t) {
    ...
    return (
      (this._mutations = this._mutations.concat(new Mn(e._key, An.none()))),
      this
    );
  }
  /**
  ...
  return ec(n, t._key).then(
    (n) =>
      new Sh(
        ...
        t._key,
        n,
        new vh(null !== n && n.hasLocalMutations, /* fromCache= */ !0),
        t.converter
      )
  );
}
...
function dl(t, e, n) {
  t = wc(t, Ic);
  const s = wc(t.firestore, xc),
    i = nl(t.converter, e, n);
  return pl(s, [
    oh(rh(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(
      t._key,
      An.none()
    ),
  ]);
...
function _l(t, e, n, ...s) {
  ...
  o =
    "string" ==
      ...
      ? _h(r, "updateDoc", t._key, e, n, s)
      : dh(r, "updateDoc", t._key, e);
...
function gl(t, ...e) {
  ...
  return (function (t, e, n, s) {
    const i = new Ba(s),
      r = new Qu(e, i, n);
    return (
      t.asyncQueue.enqueueAndForget(async () => Lu(await Xa(t), r)),
      () => {
 ...
 */ function pl(t, e) {
  return (function (t, e) {
    const n = new j();
    return (
      t.asyncQueue.enqueueAndForget(async () => ra(await Ya(t), e, n)),
      n.promise
    );
  })(Oc(t), e);
}
 ...
 */ function Il(t, e, n) {
  ...
  return new Sh(
    ...
    e._key,
    s,
    new vh(n.hasPendingWrites, n.fromCache),
    e.converter
  );
}
 ...
 */ class Tl extends class {
  ...
  update(t, e, n, ...s) {
    ...
    return (
      (r =
        "string" == typeof (e = getModularInstance(e)) || e instanceof zc
          ? _h(this._dataReader, "Transaction.update", i._key, e, n, s)
          : dh(this._dataReader, "Transaction.update", i._key, e)),
      ...
      .then(
        (t) =>
          new Sh(
            ...
            e._key,
            t._document,
            new vh(/* hasPendingWrites= */ !1, /* fromCache= */ !1),
            e.converter
          )
      );
  }
 ...
 */ function Sl(t, e) {
  ...
  if (Array.isArray(n.indexes))
    for (const t of n.indexes) {
      const e = Dl(t, "collectionGroup"),
        n = [];
      if (Array.isArray(t.fields))
        for (const e of t.fields) {
          const t = Eh("setIndexConfiguration", Dl(e, "fieldPath"));
          "CONTAINS" === e.arrayConfig
            ? n.push(new fe(t, 2 /* CONTAINS */))
            : "ASCENDING" === e.order
            ? n.push(new fe(t, 0 /* ASCENDING */))
            : "DESCENDING" === e.order && n.push(new fe(t, 1 /* DESCENDING */));
        }
 ...
 */ !(function (t, e = !0) {
  !(function (t) {
    ...
    registerVersion(D, "3.4.9", t),
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    registerVersion(D, "3.4.9", "esm2017");
})();

export {
  el as AbstractUserDataWriter,
  Jc as Bytes,
  Cc as CACHE_SIZE_UNLIMITED,
  Ec as CollectionReference,
  Ic as DocumentReference,
  Sh as DocumentSnapshot,
  zc as FieldPath,
  Yc as FieldValue,
  xc as Firestore,
  Q as FirestoreError,
  ...
  Dh as QueryDocumentSnapshot,
  Ch as QuerySnapshot,
  vh as SnapshotMetadata,
  at as Timestamp,
  Tl as Transaction,
  il as WriteBatch,
  kt as _DatabaseId,
  ...
  wc as _cast,
  q as _debugAssert,
  Rt as _isBase64Available,
  $ as _logWarn,
  Sl as _setIndexConfiguration,
  lc as _validateIsNotUsedTogether,
  ml as addDoc,
  bl as arrayRemove,
  Pl as arrayUnion,
  Lc as clearIndexedDbPersistence,
  Ac as collection,
  ...
  $c as enableMultiTabIndexedDbPersistence,
  qc as enableNetwork,
  Hh as endAt,
  zh as endBefore,
  Oc as ensureFirestoreConfigured,
  pl as executeWrite,
  ol as getDoc,
  al as getDocFromCache,
  cl as getDocFromServer,
  hl as getDocs,
  ll as getDocsFromCache,
  fl as getDocsFromServer,
  kc as getFirestore,
  Vl as increment,
  Nc as initializeFirestore,
  qh as limit,
  Kh as limitToLast,
  Qc as loadBundle,
  jc as namedQuery,
  gl as onSnapshot,
  yl as onSnapshotsInSync,
  Lh as orderBy,
  Mh as query,
  Vc as queryEqual,
  bc as refEqual,
  El as runTransaction,
  Rl as serverTimestamp,
  dl as setDoc,
  O as setLogLevel,
  Nh as snapshotEqual,
  jh as startAfter,
